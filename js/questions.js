export const HotelQuestions = [
  {
    q: "Kaip dirbtinis intelektas galėtų padėti optimizuoti 'Hotela' rezervacijų sistemą?",
    a: [
      {
  ...
  {
    q: "Kurioje srityje DI galėtų labiausiai padėti viešbučiui atsižvelgiant į kainodarą?",
    a: [
      {
        text: "Nustatant kainas pagal metų laiką",
        isCorrect: false,
        explanation:
          "Tai nėra specifiškas būdas, kaip dirbtinis intelektas gali padėti viešbučiui optimizuoti kainodarą.",
      },
      {
  ...
  },
  {
    ...
    a: [
      ...
      },
      {
        ...
        isCorrect: false,
        explanation:
          "Dizaino keitimas be analizės gali trukdyti klientams rasti tai, ko jie ieško, ir sumažinti vartotojo patirtį.",
      },
      {
...
export const HospitalQuestions = [
  {
    ...
    a: [
      ...
      {
        text: "Keičiant gydytojų darbo valandas kas savaitę",
        isCorrect: false,
        explanation:
          "Keitimas be nuoseklios analizės gali sukelti organizacinius ir darbo našumo problemas.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    a: [
      ...
      {
        text: "Analizuojant pacientų socialinius tinklus, kad suprastų jų gyvenimo būdą",
        isCorrect: false,
        explanation:
